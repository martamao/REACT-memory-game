...
The game board MUST use more available large-screen space than the current tight viewport-height cap while remaining square and avoiding unnecessary vertical overflow on standard desktop and laptop viewports.
